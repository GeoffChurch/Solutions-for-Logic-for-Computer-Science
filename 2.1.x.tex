...
\solution[
    ...
    \begin{itemize}
        ...
        \item
              Transitivity: adopting a point-free notation, showing transitivity amounts to showing $RSRS \subset RS$. Since $RS = SR$, $RSRS = RRSS$. Since $R$ and $S$ are transitive, $RR \subset R$ and $SS \subset S$, and since $M \subset N \implies (\forall x,y (xFMGy \implies xFNGy))$ for any relations $F$ and $G$ (monotonicity), we can conclude $RSRS \subset RS$.
              \\\\
