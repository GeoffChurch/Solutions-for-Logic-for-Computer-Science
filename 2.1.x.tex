...
\solution[
    ...
    \begin{itemize}
        ...
        \item
              Transitivity: adopting a point-free notation, showing transitivity amounts to showing $RSRS \subset RS$. Since $RS = SR$, $RSRS = RRSS$. Since $R$ and $S$ are transitive, $RR \subset R$ and $SS \subset S$, and since $A \subset B \implies (xAy \implies xBy)$ (monotonicity), we can conclude $RSRS \subset RS$.
              \\\\
